...
class Comment(Base):
    ...
    parent_id: Mapped[str | None] = mapped_column(ForeignKey("comments.id"), index=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow)
...
class Notification(Base):
    ...
    type: Mapped[str] = mapped_column(
        Enum("follow", "event_invite", "event_reminder", "comment",
             "going", "event_update", name="notif_type"),
        nullable=False,
    )
